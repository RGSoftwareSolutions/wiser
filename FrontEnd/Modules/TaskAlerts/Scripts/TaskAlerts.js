        ...
        onOpenTaskClick(event) {
            ...
            if (window.parent) {
                window.parent.main.vueApp.openModule({
                    ...
                    queryString: `?moduleId=${encodeURIComponent(properties.moduleId || 0)}&iframe=true&itemId=${encodeURIComponent(properties.itemId)}&entityType=${encodeURIComponent(properties.entityType || "TodoItem")}`
                });
            }
        }
